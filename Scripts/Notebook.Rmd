...
These chunks are as follows: - R Markdown setup chunk - Load libraries
required for execution - Create two vectors - one with a list of URLs of
all datasets since October 2015 from the NHS Scotland Open data website.
The other contains a list of values representing the month and year of
the datasets in the format mmyyyy. This full chunk is not included as it
would take up most of the report!
...
```{r PullAllDataFiles, results='hide', message=FALSE}
URLList <- URLList %>% 
...
LARCPlot <- LARCPlotData %>%
  ...
  labs(title = "Long Acting Reversible Contraception Prescriptions 
                \n Issued by NHS Scotland by Health Board", 
...
LARCPlotScotlandZoomed <- LARCPlotDataScotlandZoomed %>%
  ...
  scale_x_date(date_breaks="2 months", 
               ...
               minor_breaks = NULL) +
  labs(title = "Long Acting Reversible Contraception Prescriptions 
                \n Issued by NHS Scotland from Jan 2020 to Jul 2022", 
       x = "Month and Year Prescription Dispensed", 
       y = "Sum of Prescriptions Issued") +
  theme_minimal() +
  theme(legend.position = "none", 
...
LARCPlotsPatchwork <- wrap_plots(LARCPlot, 
  ...
  plot_annotation(
    ...
    tag_levels = 'A', 
    title = "Change in Prescribing Rates of Long Acting Reversible                          Contraception in Scotland over Covid-19 Lockdowns", 
    theme = theme(
