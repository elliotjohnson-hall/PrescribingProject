...
LARCPlot <- LARCPlotData %>%
  ...
  labs(title = "Long Acting Reversible Contraception Prescriptions Issued by NHS Scotland by Health Board", x = "Month and Year Prescription Dispensed", y = "Sum of Prescriptions Issued") +
